...
Die Alliance/Haecker concept130 2026 Blockdatenbank wird aus
`data/alliance_haecker_2026_concept130_blockdatenbank.csv` beim Start
automatisch geladen, wenn noch keine globale Blockbibliothek vorhanden ist.
Bestellungen koennen dadurch direkt gegen diese Vereinbarung geprueft werden.
